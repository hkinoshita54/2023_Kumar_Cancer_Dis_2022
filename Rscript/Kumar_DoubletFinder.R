...
library(patchwork)
library(Seurat)
options(Seurat.object.assay.version = "v3") # use Seurat v3 for DoubletFinder
...
# VlnPlot(seu_list[[2]], features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 4, pt.size = 0)
...
for (i in 1:length(seu_list)) {
  ...
  nExp.poi <- round(0.02 * nrow(seu@meta.data)) ## Assuming 2% doublet formation rate - tailor for your dataset
